...
namespace Pako.Infrastructure.Migrations
{
    ...
    [Migration("20260915181111_AddCompanyLockDatesAndExceptions")]
    partial class AddCompanyLockDatesAndExceptions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pako.Domain.Companies.Company", b =>
                {
                    ...
                    b.Property<bool>("AllowNumberOverride")
                        .HasColumnType("boolean");

                    b.Property<int>("EnabledProfiles")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(1);
            ...
            modelBuilder.Entity("Pako.Domain.Companies.CompanyAccountDefaults", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("CustomerDepositsAccountId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("ExpenseAccountId")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("NetPayPayableAccountId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("PitPayableAccountId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("ReverseChargeInputVatAccountId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("ReverseChargeOutputVatAccountId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("company_account_defaults", (string)null);
                });

            modelBuilder.Entity("Pako.Domain.Companies.DocumentNumberAudit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("document_number_audits", (string)null);
                });
            ...
            modelBuilder.Entity("Pako.Domain.Companies.Item", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("DefaultTaxDefinitionId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Pako.Domain.Companies.ItemBarcode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Pako.Domain.Companies.NumberSeries", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Pako.Domain.Companies.PaymentMethod", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Pako.Domain.Ledger.Account", b =>
                {
                    ...
                    b.Property<string>("CitLimitRule")
                        .HasMaxLength(512)
                        .HasColumnType("character varying(512)");
                    ...
                    b.Property<string>("DefaultVatCode")
                        .HasMaxLength(16)
                        .HasColumnType("character varying(16)");
            ...
            modelBuilder.Entity("Pako.Domain.Ledger.AccountGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Pako.Domain.Ledger.CostCenter", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Pako.Domain.Payroll.Employee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Pako.Domain.Payroll.PayrollRun", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Pako.Domain.Payroll.PayslipLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal>("EmployeePensionAmount")
                        .HasColumnType("numeric(18,2)");

                    b.Property<decimal>("EmployerPensionAmount")
                        .HasColumnType("numeric(18,2)");
                    ...
                    b.ToTable("payslip_lines", (string)null);
                });

            modelBuilder.Entity("Pako.Domain.Reconciliation.Reconciliation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Pako.Domain.Bills.Bill", b =>
                {
                    b.HasOne("Pako.Domain.Bills.Bill", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Pako.Domain.Bills.BillLine", b =>
                {
                    ...
                    b.HasOne("Pako.Domain.Companies.Item", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Pako.Domain.Companies.ItemBarcode", b =>
                {
                    b.HasOne("Pako.Domain.Companies.Item", "Item")
                        .WithMany("Barcodes")
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Pako.Domain.Invoicing.Invoice", b =>
                {
                    b.HasOne("Pako.Domain.Invoicing.Invoice", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Pako.Domain.Ledger.AccountGroup", b =>
                {
                    b.HasOne("Pako.Domain.Ledger.AccountGroup", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Pako.Domain.Payroll.PayslipLine", b =>
                {
                    b.HasOne("Pako.Domain.Payroll.PayrollRun", "PayrollRun")
                        .WithMany("Lines")
            ...
            modelBuilder.Entity("Pako.Domain.Reconciliation.Reconciliation", b =>
                {
                    ...
                    b.HasOne("Pako.Domain.Ledger.JournalEntryLine", null)
                        .WithMany()
