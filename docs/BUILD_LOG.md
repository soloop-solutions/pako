# PAKO build log (archive)

This was `CLAUDE.md` until 15 Sep 2026, when it had grown to 184 KB — roughly 46,000 tokens
loaded into every Claude Code session. It is a dated, append-only record of how the codebase
was built, from 2026-08-26 to 2026-09-08. It is kept for archaeology: read it when you need to
know *why* something was done, not to learn what the code is today.

Current context lives in `CLAUDE.md` (short index), `.claude/rules/`, and `docs/`.
