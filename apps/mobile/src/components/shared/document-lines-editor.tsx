...
export type DocumentLine = { description: string; quantity: string; unitPrice: string; taxDefinitionId: string };

export const EMPTY_DOCUMENT_LINE: DocumentLine = { description: '', quantity: '1', unitPrice: '', taxDefinitionId: '' };
